...
Game_Interpreter.prototype.command318 = function () {
	const val = MATTIE.multiplayer.equipmentEmitter.changeSkill.call(this);
...
Game_Actor.prototype.changeEquip = function (slotId, item, ignore = false) {
	const val = MATTIE.multiplayer.equipmentEmitter.changeEquipment.call(this, slotId, item);
