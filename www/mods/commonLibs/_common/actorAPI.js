...
MATTIE.actorAPI.forceMainChar = function (i) {
	var lastBattleMembers = Game_Party.prototype.battleMembers;
	Game_Party.prototype.battleMembers = function () {
		var val = lastBattleMembers.call(this);
...
MATTIE.actorAPI.Data_Actor_Wrapper = class {
	...
	buildDefaultDataActor(shouldSet = true) {
		/** @type {MATTIE.actorAPI.Data_Actor} */
		var dataActor = new MATTIE.actorAPI.Data_Actor();
	...
	buildDataActorFromEventAndTroop(gameEvent, gameTroop, page = 0) {
		this.buildDataActorFromExistingActor(JsonEx.makeDeepCopy($dataActors[1]));
     ...
     */
	getDefaultTraits() {
		var fearAndHunger1 = $dataActors[1].traits;
     ...
     */
	getDefaultEquip() {
		var fearAndHunger1 = $dataActors[1].equips;
		if (MATTIE.global.version === 1) return fearAndHunger1;
	}
