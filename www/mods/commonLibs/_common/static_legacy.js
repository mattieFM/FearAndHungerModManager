...
/**
 * @file static_legacy.js
 * @description Legacy inline game-data fallback for MATTIE.static.update().
 *
 * Contains the original isFunger() and isTermina() branches that were
 * extracted from static.js during the game module refactoring (Phase 11).
 * This file is NOT loaded automatically — it is kept for reference/recovery.
 *
 * To restore: manually call MATTIE.static._legacyUpdate().
 *
 * @see www/mods/game-modules/fearAndHunger1.js  (F&H1 module)
 * @see www/mods/game-modules/termina.js          (Termina module)
 */

// LEGACY FALLBACK — call MATTIE.static._legacyUpdate() to re-apply
MATTIE.static._legacyUpdate = function () {
